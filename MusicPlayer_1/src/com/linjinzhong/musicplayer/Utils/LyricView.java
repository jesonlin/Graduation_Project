	...
	protected void onDraw(Canvas c) {
		...
		if (lrc != null) {
			try {
				...
				for (Long l : ts) {
					Log.e("LyricView", "getMeasuredWidth()="+getMeasuredWidth()+"行长="+lrcPaint.measureText(lrc.get(l)));
					c.drawText(lrc.get(l), (getMeasuredWidth()-lrcPaint.measureText(lrc.get(l)))/2, h,
